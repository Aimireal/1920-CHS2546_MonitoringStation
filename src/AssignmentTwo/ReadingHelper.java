...
/**
* AssignmentTwo/ReadingHelper.java .
...
{
  private static String  _id = "IDL:AssignmentTwo/Reading:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[3] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (AssignmentTwo.ReadingHelper.id (), "Reading", _members0);
          __active = false;
        }
      }
    }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, AssignmentTwo.Reading value)
  {
    ...
    ostream.write_long (value.reading_level);
  }

...
/**
* AssignmentTwo/readingListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from AssignmentTwo.idl
* Tuesday, 31 March 2020 19:26:32 o'clock BST
*/

abstract public class readingListHelper
{
  private static String  _id = "IDL:AssignmentTwo/readingList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (AssignmentTwo.readingListHelper.id (), "readingList", __typeCode);
    }
    return __typeCode;
  }

...
/**
* AssignmentTwo/StationDetailsHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from AssignmentTwo.idl
* Monday, 13 April 2020 17:15:40 o'clock BST
*/

abstract public class StationDetailsHelper
{
  private static String  _id = "IDL:AssignmentTwo/StationDetails:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (AssignmentTwo.StationDetailsHelper.id (), "StationDetails", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    AssignmentTwo.StationDetails value = new AssignmentTwo.StationDetails ();
